...
import { Backicon, CopyBtn, DasedSpan } from '../helper/Icon'
...
export default function Sidebar() {
  ...
  const caAdd = 'DCMJcu2pqr4k5YGmdGkEPkTjyngT9vaHLKBFSC9jK5Sn'
  const copyCA = () => {
    const textToCopy = caAdd;
    ...
    >
      ...
      >
        ...
        <div className='flex justify-between gap-4 mb-4 sm:mb-6 md:mb-8 lg:mb-10 px-8 md:px-12 lg:px-16 xl:px-24 2xl:px-28'>
          ...
          <button onClick={copyCA} className={`text-[#1B1B1B] flex items-center gap-2 truncate`}>
            <div className='max-w-8 md:max-w-12 lg:max-w-16'>
              <Image src={'/assets/png/ca.png'} alt='ca button' width={100} height={100} />
            </div>
            <p className='text-[#1B1B1B] font-helvetica-neue-condensed text-xl md:text-2xl truncate font-bold'>{caAdd}</p>
