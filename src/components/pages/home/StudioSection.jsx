  ...
  return (
    <div className='w-full relative'>
      <div className="flex w-full justify-center items-end gap-2 max-h-[500px] -mb-5 relative ">
        <div className='absolute -top-20 2xl:-top-14  w-full flex justify-center -z-10 '>
          <div className='max-w-[380px] xl:max-w-[500px] 2xl:ml-16 rotate-12'>
            <Image src={'/assets/webp/poster.webp'} alt="poster img" width={500} height={500} className='w-full h-auto' />
          </div>
        </div>
        <div>
