  ...
  return (
    <div className='mt-8 sm:mt-12 md:mt-14 lg:mt-16 xl:mt-20 2xl:mt-24'>
      ...
      {ClimbingRankData.map((data, index) => (
        <div key={index} className='border-2 lg:border-4 border-[#E04B77] rounded-3xl lg:rounded-[45px] xl:rounded-[69px] pl-4 md:pl-6 pr-4 sm:pr-8 lg:px-8 xl:px-12 2xl:px-14 py-4 md:py-7 lg:py-9 mb-10 relative'>
