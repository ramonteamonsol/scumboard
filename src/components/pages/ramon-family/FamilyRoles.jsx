...
export default function FamilyRoles() {
  return (
    <div className='mt-8 sm:mt-12 md:mt-14 lg:mt-16 xl:mt-20 2xl:mt-24'>
      <h3 className='text-white text-3xl lg:text-4xl 2xl:text-5xl mb-2 md:mb-5 !leading-[163%] pl-4 md:pl-6 lg:pl-8 xl:pl-12 2xl:pl-14'>Famiglia Roles</h3>
      {FamilyRolesData.map((data, index) => (
        <div key={index} className='border-2 lg:border-4 border-white/75 rounded-3xl lg:rounded-[45px] xl:rounded-[69px] px-4 md:px-6 lg:px-8 xl:px-12 2xl:px-14 py-4 md:py-7 lg:py-9 mb-10'>
          ...
          <div className='flex flex-col md:flex-row mt-5 lg:mt-10 gap-4 lg:gap-5 xl:gap-10'>
            ...
            <div className='md:w-1/2'>
              ...
              <ul className='mt-2.5 md:mt-4 lg:mt-6 space-y-1.5 md:space-y-2'>
